...
module.exports.handleEvent = async ({ api, event, Users }) => {
    ...
    const morning = [
        `Chào buổi sáng ${userName}, mình là bot của Tao rat dep trai, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi sáng vui vẻ!`
    ];

    const afternoon = [
      `Chào buổi trưa ${userName}, mình là bot của tao rat derat dep trai, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi sáng vui vẻ!`
    ];

    const evening = [
      `Chào buổi chiều ${userName}, mình là bot của tao rat dep trai, mình có thể giúp gì được cho bạn?`,
        `Chào ${userName}, chúc bạn buổi sáng vui vẻ!`
    ];

    const night = [
        `Chào buổi tối ${userName}, mình là bot của tao rat dep trai, mình có thể giúp gì được cho bạn?`,
